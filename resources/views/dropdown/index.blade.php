                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ url('/dropdown/store') }}" method="POST">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control"
                                                                            id="name_value" name="name_value"
                                                                            placeholder="Enter Dropdown Name Value"
                                                                            required>
                                                                    </div>
                                                                    <br>
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control"
                                                                            id="code_format" name="code_format"
                                                                            placeholder="Enter Dropdown Code Format"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($dropdown as $data)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button title="Edit Dropdown"
                                                                        class="btn btn-primary btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#modal-update{{ $data->id }}">
                                                                        <i class="fas fa-edit"></i>
                                                                    </button>
                                                                    <button title="Delete Dropdown"
                                                            ...
                                                            <div class="modal fade" id="modal-update{{ $data->id }}"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form
                                                                            action="{{ url('/dropdown/update/' . $data->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('patch')
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text"
                                                                                        ...
                                                                                        id="code_format"
                                                                                        name="code_format"
                                                                                        placeholder="Enter Code Format Value"
                                                            ...
                                                            <div class="modal fade" id="modal-delete{{ $data->id }}"
                                                                tabindex="-1"
                                                                aria-labelledby="modal-delete{{ $data->id }}-label"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title"
                                                                                id="modal-delete{{ $data->id }}-label">
                                                                                Delete Dropdown</h4>
                                                                            <button type="button" class="btn-close"
                                                                                data-bs-dismiss="modal"
                                                                                aria-label="Close"></button>
                                                                        ...
                                                                        <form
                                                                            action="{{ url('/dropdown/delete/' . $data->id) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('delete')
                                                                            <div class="modal-body">
                                                                                <div class="form-group">
                                                                                    Are you sure you want to delete <label
                                                                                        for="Dropdown">{{ $data->name_value }}</label>?
                                                                                </div>
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button"
